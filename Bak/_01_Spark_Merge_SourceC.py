...
#spark-submit  --master yarn --py-files ./_Setting.py --deploy-mode cluster --conf "spark.default.parallelism=15" ./_01_Spark_Merge_SourceC.py
...
if __name__ == "__main__":
    ...
    spark = SparkSession.builder \
        .appName("_01_Spark_Merge_SourceC") \
        .getOrCreate()  
